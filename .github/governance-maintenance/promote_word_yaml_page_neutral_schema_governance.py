...
OLD_UID='GOV-REV-20260923-WORD-YAML-PRESTAGE01-SOURCE-FIDELITY-HARDENING'
NEW_UID='GOV-REV-20260923-WORD-YAML-PAGE-NEUTRAL-SCHEMA-PORTABILITY-HARDENING'
OLD_DISPLAY='v2.2.18'
NEW_DISPLAY='v2.2.19'
OLD_REV='v2.2.18-word-yaml-page-neutral-schema-portability-hardening'
NEW_REV='v2.2.19-word-yaml-page-neutral-schema-portability-hardening'
AUTH_UID='USR-DIRECTIVE-20260923-WORD-YAML-PAGE-NEUTRAL-SCHEMA-HARDENING-R2'
WORK_UNIT='WU-GOV-WORD-YAML-PRESTAGE01-HARDENING-001'
NEW_PACKAGE='AI_WEB_GOVERNANCE_FULL_LIFECYCLE_v2.2.19_WORD_YAML_PAGE_NEUTRAL_SCHEMA_PORTABILITY_HARDENING_LOCAL_VERIFIED.zip'
...
def prepare_source_candidate_state():
    ...
    g=load(gp)
    g['candidate']='v2.2.19_WORD_YAML_PAGE_NEUTRAL_SCHEMA_PORTABILITY_HARDENING_CANDIDATE'
...
def refresh_source():
    ...
    if '## v2.2.19 Word/YAML page-neutral schema portability hardening' not in rs:
    ...
    if '## v2.2.19 page-neutral projection schema portability rule' not in vs:
...
def update_current(semantic,checks,bundle,zips):
    ...
    unique_extend(r['active_specification'].setdefault('aliases',[]),['word-yaml-page-neutral-schema-portability-hardening'])
    r['immediate_predecessor']={
      ...
      'status':'SUPERSEDED_HISTORY_ONLY_AFTER_WORD_YAML_PAGE_NEUTRAL_SCHEMA_PORTABILITY_HARDENING'
    }
    dump(rp,r)
    ...
    a['status']='WORD_YAML_PAGE_NEUTRAL_SCHEMA_SUCCESSOR_PROMOTED_EXACT_HEAD_REVALIDATION_REQUIRED'
    a['next_action']='RUN_EXACT_HEAD_WORD_YAML_PAGE_NEUTRAL_SCHEMA_VALIDATION'
    ...
    gt.update({
      ...
      'fresh_revalidation_scope':'WORD_YAML_PAGE_NEUTRAL_SCHEMA_POLICY_CONSUMERS_ONLY_NO_PRODUCT_STAGE_CREDIT',
    ...
    rc['current_resume_point']='WORD_YAML_PAGE_NEUTRAL_SCHEMA_SUCCESSOR_PROMOTED_EXACT_HEAD_REVALIDATION_REQUIRED'
    rc['current_work_unit_uid']=WORK_UNIT
    rc['exact_next_action']='RUN_EXACT_HEAD_WORD_YAML_PAGE_NEUTRAL_SCHEMA_VALIDATION'
    ...
    sd['next_action']='RUN_EXACT_HEAD_WORD_YAML_PAGE_NEUTRAL_SCHEMA_VALIDATION'
...
def main():
    ...
    validate_all()
    for p in [
      ROOT/'.github/workflows/word-yaml-page-neutral-schema-governance-promotion.yml',
      ROOT/'.github/governance-maintenance/promote_word_yaml_page_neutral_schema_governance.py'
    ]:
    ...
    msg='feat(governance): promote Word YAML page-neutral schema portability hardening\n\nSpec-Change-Authorization: '+AUTH_UID+'\nSpec-Change-Scope: WORD_YAML_PAGE_NEUTRAL_FIXED_SCHEMA_DYNAMIC_CONTENT_PORTABILITY'
