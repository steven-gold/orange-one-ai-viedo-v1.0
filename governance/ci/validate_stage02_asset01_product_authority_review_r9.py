...
expected_denominators = {
    'asset01_open_product_authority_decisions': len(expected),
...
print(f'PASS: R9 exact Current ASSET-01 blocker set={len(expected)} and matches R6 one-for-one')
print(f'PASS: Current ASSET-01 category counts={expected_categories}')
