  ...
  return <div className={styles.page} data-page-uid="admin:DB-01" data-vis-step="VIS-07" data-page-state="READ_ONLY" data-authority-controls="49" data-registry-valid={registryValid?"true":"false"}>
    ...
    <div className={styles.primaryGrid}>
      ...
      <main className={styles.centerStack}>
        ...
        <section className={styles.panel} data-section-id="DB-01-SEC-04" data-visual-uid="DB-01-VIS-RELATION" data-component-uid="DB-01-CMP-RELATIONS"><Title text={dbUiText(locale,"relations")}/><Control spec={RELATIONS[0]}/><div className={styles.relationGrid}><Control spec={RELATIONS[1]}/><Control spec={RELATIONS[2]}/></div></section>
      </main>
