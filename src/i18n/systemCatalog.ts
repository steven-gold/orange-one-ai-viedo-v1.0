...
export const SYSTEM_CATALOG = {
  ...
  runtimeReady: { "zh-TW": "Runtime 已接通；操作依目前資料與權限條件啟用。", "zh-CN": "Runtime 已接通；操作依当前数据与权限条件启用。", en: "Runtime is bound; actions enable when current data and permission gates are satisfied." },
  draftRequired: { "zh-TW": "請先在設計對話輸入本次變更需求。", "zh-CN": "请先在设计对话输入本次变更需求。", en: "Enter the current change requirement in Design Conversation first." },
  candidateRequired: { "zh-TW": "需先建立目前變更候選。", "zh-CN": "需先建立当前变更候选。", en: "Create the current change candidate first." },
  candidateCreated: { "zh-TW": "變更候選已建立。", "zh-CN": "变更候选已建立。", en: "Change candidate created." },
  changeRequestCreated: { "zh-TW": "變更請求已建立。", "zh-CN": "变更请求已建立。", en: "Change request created." },
  sandboxPassed: { "zh-TW": "Sandbox 編譯測試已通過。", "zh-CN": "Sandbox 编译测试已通过。", en: "Sandbox compilation test passed." },
