...
assert all(not missing(x["matches"][0]["action"]) for x in maps),[(x["compact_uid"],x["matches"][0]["action"]) for x in maps]
assert all(not missing(x["matches"][0]["gate"]) for x in maps),[(x["compact_uid"],x["matches"][0]["gate"]) for x in maps]
