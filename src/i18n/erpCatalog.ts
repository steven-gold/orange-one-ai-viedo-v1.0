...
export const ERP_TEXT = {
  ...
  waitingForData: { "zh-TW": "等待授權投影", "zh-CN": "等待授权投影", en: "Awaiting authorized projection" },
  dataLoaded: { "zh-TW": "已載入授權投影", "zh-CN": "已加载授权投影", en: "Authorized projection loaded" },
  formTitle: { "zh-TW": "操作表單", "zh-CN": "操作表单", en: "Action form" },
  submitAction: { "zh-TW": "送出操作", "zh-CN": "提交操作", en: "Submit action" },
  cancel: { "zh-TW": "取消", "zh-CN": "取消", en: "Cancel" },
  confirmAction: { "zh-TW": "確認執行受控操作", "zh-CN": "确认执行受控操作", en: "Confirm governed action" },
  fieldProviderKey: { "zh-TW": "Provider Key", "zh-CN": "Provider Key", en: "Provider Key" },
  fieldAdapterKey: { "zh-TW": "Adapter Key", "zh-CN": "Adapter Key", en: "Adapter Key" },
  fieldSecretReferenceId: { "zh-TW": "Secret Reference ID", "zh-CN": "Secret Reference ID", en: "Secret Reference ID" },
  fieldEntityScope: { "zh-TW": "Entity Scope", "zh-CN": "Entity Scope", en: "Entity Scope" },
  fieldMappingVersion: { "zh-TW": "Mapping Version", "zh-CN": "Mapping Version", en: "Mapping Version" },
  fieldMappingEntityName: { "zh-TW": "Mapping Entity Name", "zh-CN": "Mapping Entity Name", en: "Mapping Entity Name" },
  fieldMappingSourceSchema: { "zh-TW": "Source Schema", "zh-CN": "Source Schema", en: "Source Schema" },
  fieldMappingTargetSchema: { "zh-TW": "Target Schema", "zh-CN": "Target Schema", en: "Target Schema" },
  fieldMappingTransformSpec: { "zh-TW": "Transform Spec", "zh-CN": "Transform Spec", en: "Transform Spec" },
  fieldDataClassification: { "zh-TW": "資料分類", "zh-CN": "数据分类", en: "Data Classification" },
  fieldRequestedScope: { "zh-TW": "要求的 Scope", "zh-CN": "要求的 Scope", en: "Requested Scope" },
  fieldSnapshotType: { "zh-TW": "Snapshot 類型", "zh-CN": "Snapshot 类型", en: "Snapshot Type" },
  fieldSnapshotDocument: { "zh-TW": "Snapshot 文件", "zh-CN": "Snapshot 文件", en: "Snapshot Document" },
  fieldRecordsPayload: { "zh-TW": "Records Payload", "zh-CN": "Records Payload", en: "Records Payload" },
  fieldCompleteness: { "zh-TW": "完整度", "zh-CN": "完整度", en: "Completeness" },
  fieldExternalResultVerified: { "zh-TW": "外部結果已驗證", "zh-CN": "外部结果已验证", en: "External Result Verified" },
  fieldExternalEvidenceRefs: { "zh-TW": "外部證據 Ref（逗號分隔）", "zh-CN": "外部证据 Ref（逗号分隔）", en: "External Evidence Refs (comma separated)" },
  fieldExportScope: { "zh-TW": "匯出 Scope", "zh-CN": "导出 Scope", en: "Export Scope" },
