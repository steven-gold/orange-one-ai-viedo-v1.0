...
def validate(root=ROOT):
    ...
    if iv.get('impact_and_reverse_dependency_index_loading_required') is not True or iv.get('validation_impact_index_required') is not True or iv.get('reverse_dependency_index_required') is not True: failures.append('indexed_validation_core_contract_missing')
