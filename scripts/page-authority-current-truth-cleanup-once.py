...
# INFO-01 is Current but is explicitly non-L1 under the Current Navigation Authority.
...
# IAM-01 must expose only the Current 8+8 L1 configuration choices; INFO/KB remain Current non-L1 pages.
...
# Permanent regression against revival of the superseded page-level execution snapshots and 9x9 navigation model.
...
test("INFO and IAM follow the Current 8+8 navigation authority", async () => {
  ...
  assert.doesNotMatch(iam, /FRONT-L1-09|ADMIN-L1-KNOWLEDGE|9X9|前台 9 L1|後台 9 L1|all nine|Nine frontend|Nine backend/);
