...
def _projection_fixture(root):
    ...
    proj['projection_content_hash']=g._hash_without(proj,'projection_content_hash'); proj['status']='PROJECTION_COMPLETE'; write(root/f'{base}/CANONICAL_SOURCE_PROJECTION.yaml',proj)
