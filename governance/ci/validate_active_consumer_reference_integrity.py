...
STAGE01_BINDING = ROOT / 'governance/test/STAGE01_ACTIVE_BINDING.yaml'
TARGETED_WORKFLOW = ROOT / '.github/workflows/targeted-stage01-stage02.yml'
...
def main() -> int:
    ...
    try:
        ...
        stage01 = load_yaml(STAGE01_BINDING)
        ...
        projector_values = {
            ...
            rel(STAGE01_BINDING): ((stage01.get('current_governance_resolution') or {}).get('governance_uid')),
    ...
    print('PASS: Registry, Manifest, Current entrypoint, Active State, and Stage-01 projectors share one immutable governance UID')
