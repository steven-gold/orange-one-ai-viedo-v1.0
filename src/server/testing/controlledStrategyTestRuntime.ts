...
export function readControlledStrategyTestProjection() {
  ...
  return {
    ...
    action_enabled: {
      "admin:STR-01::ACT-SEARCH": true,
      "admin:STR-01::ACT-REFRESH": true,
      "admin:STR-02::ACT-CONFIGURE": true,
      "admin:STR-02::ACT-APPROVE": true,
      "admin:STR-03::ACT-DRAFT-SAVE": true,
      "admin:STR-03::ACT-APPROVE": true,
      "admin:STR-04::ACT-SEARCH": true,
      "admin:STR-04::ACT-EXPORT": true,
      "admin:STR-05::ACT-CANDIDATE-CREATE": true,
      "admin:STR-05::ACT-APPROVE": true,
      "admin:STR-06::ACT-CANDIDATE-COMPARE": true,
      "admin:STR-06::ACT-ADOPT-CONTEXT": true,
